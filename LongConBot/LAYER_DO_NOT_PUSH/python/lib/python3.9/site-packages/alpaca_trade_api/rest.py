...
class MarketType(Enum):
    crypto = {"endpoint_base": "crypto", "api_version": "v1beta1"}
    stocks = {"endpoint_base": "stocks", "api_version": "v2"}
...
class REST(object):
    ...
    def _data_get(self,
        ...
        api_version = market_type.value["api_version"]
        endpoint_base = market_type.value["endpoint_base"]
        if market_type == MarketType.crypto:
            kwargs.pop('adjustment')
