...
class Client(object):
    ...
    def update_client(self, api_key=None, api_secret=None, is_testnet=False):
        self.api_key = api_key
        self.api_secret = api_secret
        self.api_URL = self.MAIN_NET_API_URL
        if is_testnet:
